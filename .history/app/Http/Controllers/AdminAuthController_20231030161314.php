...
class AdminAuthController extends Controller
{
    ...
    public function RequestPassword(Request $request)
    {
        ...
        $user = Admin::where(function ($query) use ($login) {
    ...
    public function login(Request $request)
    {
        ...
        $user = Admin::where($fieldType, $data)->first();
    ...
    public function register(Request $request)
    {
        ...
        if ($this->checkuser($phone, $request->email)) {
            ...
            $message = new SmsController();
            $mssg = "Hello ".$request->name."Welcome to Currency Trader";
    ...
    {
        $phones = Admin::where('phone', $phone)->get();
        $emails = Admin::where('email', $email)->get();
